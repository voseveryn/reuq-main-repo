...
export type UseSlugValueProps = SlugInputOwnProps & {
...
export const useSlugInput = ({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: we don't want to re-run this effect when the fieldAccessorGetters change
	useEffect(() => {
	...
	return {
		...
		parseValue: useCallback<FormInputHandler['parseValue']>(
			val => {
		...
		formatValue: useCallback<FormInputHandler['formatValue']>(
			value => {
